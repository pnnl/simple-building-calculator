    ...
    <>
      <Row>
        ...
        <Col xs={6}>
          ...
          <Button className="pull-right" variant="danger" id="cancel" onClick={()=>{if(window.confirm("Do you want to cancel your changes?")){navigate('/simple-building-calculator/scenario')}}}>Cancel</Button>
